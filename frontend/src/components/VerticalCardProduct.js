                ...
                {/* Loaad ảo */}
                {
                    loading ? (
                        ...
                        data.map((product, index) => {
                            return (
                                <Link to={"product/"+product?._id} key={product?._id || `product-${index}`} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow-md hover:shadow-custom transition-shadow duration-200'>
