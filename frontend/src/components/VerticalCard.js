    ...
    {/* Loaad ảo */}
    {
        loading ? (
            ...
            data.map((product, index) => {
                return (
                    <Link key={product?._id} to={"/product/"+product?._id} className='w-full min-w-[280px] md:min-w-[290px] max-w-[280px] md:max-w-[290px] bg-white rounded-sm shadow-md hover:shadow-custom transition-shadow duration-200 mt-4' onClick={scrollTop}>
